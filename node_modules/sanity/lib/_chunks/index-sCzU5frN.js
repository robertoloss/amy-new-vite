...
var desk = require('./desk-ogKTlEK-.js');
...
function StructureError(_ref8) {
  ...
  const {
    t
  } = sanity.useTranslation(desk.structureLocaleNamespace);
...
const DeskToolPane = React.memo(function DeskToolPane2(props) {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(PaneRouterProvider, {
    ...
    children: /* @__PURE__ */jsxRuntime.jsx(React.Suspense, {
      fallback: /* @__PURE__ */jsxRuntime.jsx(desk.LoadingPane, {
        paneKey,
        path,
        selected
      }),
...
var _a;
const StyledPaneLayout = styled__default.default(desk.PaneLayout)(_a || (_a = __template(["\n  min-height: 100%;\n  min-width: 320px;\n"])));
const isSaveHotkey = isHotkey__default.default("mod+s");
const DeskTool = React.memo(function DeskTool2(_ref11) {
  let {
    onPaneChange
  } = _ref11;
  var _a2;
    ...
    children: [/* @__PURE__ */jsxRuntime.jsxs(StyledPaneLayout, {
      ...
      children: [paneDataItems.map(_ref12 => {
        ...
        return /* @__PURE__ */jsxRuntime.jsx(React.Fragment, {
          children: pane === desk.LOADING_PANE ? /* @__PURE__ */jsxRuntime.jsx(desk.LoadingPane, {
            paneKey,
            path,
            selected
      ...
      }), paneDataItems.length <= 1 && isResolvingIntent && /* @__PURE__ */jsxRuntime.jsx(desk.LoadingPane, {
...
//# sourceMappingURL=index-sCzU5frN.js.map
