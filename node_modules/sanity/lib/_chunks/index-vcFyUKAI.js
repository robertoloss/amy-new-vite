...
import { Card, Container, Heading, Stack, Label, Code, Box, Text, Button, Flex, useToast, useTheme, PortalProvider, ErrorBoundary } from '@sanity/ui';
import { usePaneLayout, ChildLink, BackLink, ReferenceChildLink, ParameterizedLink, PaneRouterContext, useDeskTool, LOADING_PANE, structureLocaleNamespace, SerializeError, Pane, PaneHeader, PaneContent, LoadingPane, PaneLayout, setActivePanes, DeskToolProvider } from './desk-Lv3-4p-G.js';
...
const paneMap = {
  component: lazy(() => import('./index-1eVMM9hT.js')),
  document: lazy(() => import('./pane-EjPa6RIS.js')),
  documentList: lazy(() => import('./pane-6Nd1D3WL.js')),
  list: lazy(() => import('./index-qT_-Ghuf.js'))
};
...
const DeskTool = memo(function DeskTool2(_ref11) {
  let {
    onPaneChange
  } = _ref11;
  var _a2;
