 ...
 * @internal
 */
export declare type DocumentListPaneProps = BaseDeskToolPaneProps<'documentList'>
 ...
 * @internal
 */
export declare const DocumentPane: React_2.NamedExoticComponent<DocumentPaneProviderProps>
...
declare const structureLocaleStrings: {
  ...
  'action.restore.confirm-dialog.confirm-discard-changes': string
