...
async function getBuildAction() {
  const mod = await Promise.resolve().then(function () {
    return require('./buildAction-YquxJj-q.js');
  });
  return mod.default;
}
const checkCommand = {
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deployAction-u9b43F2x.js');
    });
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./listApisAction-7WwDODHk.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$4
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deployApiAction-QWOFGUBN.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$3
...
//# sourceMappingURL=_internal-KAvB2DPq.js.map
